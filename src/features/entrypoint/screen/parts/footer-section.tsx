  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col items-center justify-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row">
          <Link
            ...
            className="rounded-lg bg-primary px-10 py-4 text-sm font-bold uppercase tracking-widest text-bg-primary transition-all hover:shadow-[0_0_40px_rgba(0,255,136,0.3)]"
          >
      ...
      <footer className="w-full max-w-6xl border-t border-border-light pt-8">
        ...
        {/* Bottom bar */}
        <div className="mt-6 flex flex-col items-center justify-center gap-2 border-t border-border-light pt-4 text-[8px] uppercase tracking-widest text-text-tertiary sm:flex-row">
          <span>&copy; 2026 WatchDog. All Rights Reserved.</span>
        </div>
      </footer>
    </section>
  );
